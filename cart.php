...
<html lang="en">
    <head>
        ...
        <!--CSS-->
        <link rel="stylesheet" type="text/css" href="/3/css/home.css">
        <link rel="stylesheet" type="text/css" href="/3/css/cart.css">
                ...
                <form action="updatecart.php" method="post" name="fromupdate">
                    <table class="table table-warning">
                        <thead>
                            <tr>
                                <th id="t1">รูป</th>
                                <th id="t1">รหัสสินค้า</th>
                                <th id="t1">ชื่อสินค้า</th>
                                <th id="t1">รายละเอียด</th>
                                <th id="t1">จำนวน</th>
                                <th id="t1">ราคาต่อหน่วย</th>
                                <th id="t1">จำนวนเงิน</th>
                                <th id="t1">&nbsp;</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($meResult = mysql_fetch_assoc($meQuery))
                            {
                                ...
                                ?>
                                <tr>
                                    <td id="t1"><img src="images/<?php echo $meResult['product_img_name']; ?>" border="0"></td>
                                    <td id="t1"><?php echo $meResult['product_code']; ?></td>
                                    <td id="t1"><?php echo $meResult['product_name']; ?></td>
                                    <td id="t1"><?php echo $meResult['product_desc']; ?></td>
                                    <td>
